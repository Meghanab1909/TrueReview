...
from analysis_engine.cyclomatic_complexity import compute_cyclomatic_complexity
...
def run_full_pipeline():
    ...
    for pr in data:
        ...
        # -------------------------
        complexity = compute_cyclomatic_complexity(pr)
        pr["cyclomatic_complexity"] = complexity
        print(f"   🔀 Complexity: {complexity['total_complexity']} ({complexity['complexity_label']})")
    ...
    "cyclomatic_complexity": {
        "total": pr["cyclomatic_complexity"]["total_complexity"],
        "label": pr["cyclomatic_complexity"]["complexity_label"],
        "score": pr["cyclomatic_complexity"]["complexity_score"],
        "file_breakdown": pr["cyclomatic_complexity"]["file_breakdown"],
    },
    "meta": {
